...
abstract class Zend_Db_Adapter_Pdo_Abstract extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        try {
        	/*
        	echo("mysql:host=localhost; port=3306; dbname=redeworking");
        	echo("<br>");
        	echo($dsn);
        	echo("<br>");
				var_dump("mysql:host=localhost; port=3306; dbname=redeworking",
...
$this->_connection = new PDO("mysql:host={$host}; port={$port}; dbname={$name}", $user, $pass,$opcoes);//new PDO($dsn, $user, $password);
//die('PASSOU');
